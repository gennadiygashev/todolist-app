...
export const deleteCard = (currentUser: string, currentFolder: string, elementID: string, cardLength: number) => action(ActionType.DELETE_CARD, {currentUser, currentFolder, elementID, cardLength})
